        ...
        return (
            <button
                ...
                style={{
                    ...
                    border: `1.5px solid ${inList ? '#ef4444' : 'var(--border)'}`,
                    background: inList ? '#fff1f2' : 'var(--bg-elevated)',
                    color: inList ? '#ef4444' : 'var(--text-secondary)',
    ...
    return (
        <button
            ...
            style={{
                ...
                color: inList ? '#ef4444' : 'var(--text-tertiary)',
                fontSize: '1rem',
                cursor: busy ? 'not-allowed' : 'pointer',
